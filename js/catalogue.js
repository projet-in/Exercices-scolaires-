...
M1:{
  ...
  'Découvertes':[
    {id:'compter3', titre:'Compter jusqu\u2019\u00e0 3', emoji:'🐥', type:'gen', ref:'compter', params:{max:3}},
...
M2:{
  ...
  'Découvertes':[
    {id:'compter5', titre:'Compter jusqu\u2019\u00e0 5', emoji:'🐥', type:'gen', ref:'compter', params:{max:5}},
...
M3:{
  ...
  'Découvertes':[
    {id:'compter10', titre:'Compter jusqu\u2019\u00e0 10', emoji:'🔟', type:'gen', ref:'compter', params:{max:10}},
...
P1:{
  'Mathématiques':[
    {id:'add20', titre:'Additions jusqu\u2019\u00e0 20', emoji:'➕', type:'gen', ref:'calc', params:{ops:['+'], max:20}},
    {id:'sous20', titre:'Soustractions jusqu\u2019\u00e0 20', emoji:'➖', type:'gen', ref:'calc', params:{ops:['-'], max:20}},
...
P2:{
  'Mathématiques':[
    {id:'add100', titre:'Additions jusqu\u2019\u00e0 100', emoji:'➕', type:'gen', ref:'calc', params:{ops:['+'], max:100}},
    {id:'sous100', titre:'Soustractions jusqu\u2019\u00e0 100', emoji:'➖', type:'gen', ref:'calc', params:{ops:['-'], max:100}},
...
P3:{
  'Mathématiques':[
    {id:'calc1000', titre:'Calcul jusqu\u2019\u00e0 1000', emoji:'🧮', type:'gen', ref:'calc', params:{ops:['+','-'], max:1000}},
...
S1:{
  ...
  'Langues modernes': blocLangues('en_S1','nl_S1','en2','nl2','en2','nl2','en3','nl2')
},
S2:{
  'Mathématiques':[
