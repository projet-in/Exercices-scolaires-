...
function ecouterReponse(){
  if(!ReconnaissanceVocale){ lireVoix("Désolé, ton navigateur ne permet pas la réponse à l'oral."); return; }
  ...
  try{
    ...
    if(btnMic) btnMic.textContent = '🎤 Je t\u2019écoute...';
    rec.onresult = (ev)=>{
      ...
      else lireVoix("Je n'ai pas bien entendu. Réessaie, ou touche ta réponse.");
    };
    rec.onerror = ()=>{ if(btnMic) btnMic.textContent = '🎤 Répondre à l\u2019oral'; };
    rec.start();
  }catch(e){}
}
